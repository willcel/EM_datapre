...
% clear
dbstop if error
folder_path = 'D:\willcel\11.6汤山\测线6';
needExaminDetail = 1;
...
for k = 1:ns
    k
    % 获取文件夹内所有的 txt 文件名
    volt_files = dir(fullfile(folder_path,num2str(k), '*_192.168.2.60_0_*.txt'));
    curr_files = dir(fullfile(folder_path,num2str(k), '*_192.168.2.60_1_*.txt'));
